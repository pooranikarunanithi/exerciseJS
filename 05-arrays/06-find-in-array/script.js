...
(() => {
    ...
    //console.log(people.find(c => c.firstname == "Gabe"));
    console.log(people.find(c => c.firstname == "Jean" && c.lastname == "Dupont").email);
    console.log(people.findIndex(c => c.email== people.find(c => c.firstname == "Jean" && c.lastname == "Dupont").email));
    //console.log(people.indexOf(people.find(c => c.firstname == "Jean" && c.lastname == "Dupont").email))
